...
public class LVCustomViewPagerIndicator extends HorizontalScrollView implements ILVView, PageIndicator {
     LuaValue mInitParams;
     UDCustomViewPagerIndicator mLuaUserdata;

    //数据
      IcsLinearLayout mLayout;
     ...
     * @return
     */
     View createAndRenderView(int pos) {
         int currentItem = mViewPager.getCurrentItem();
         LuaValue cellData = createView(pos, currentItem);
